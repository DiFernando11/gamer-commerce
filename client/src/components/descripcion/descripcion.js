 ...
 <div className = {styles.containerpadre}>
     <div className = {styles.containerbody}>
        <div className = {styles.colum1}>
            ...
            aspirantes a estrellas y famosos en decadencia tratando de mantenerse a flote en una era de incertidumbre económica y tele por cable barata. 
            En medio de esta confusión, 
            tres criminales muy distintos lo arriesgan todo en una serie de audaces y peligrosos asaltos que podrían solucionarles la vida.
            </p>
        ...
        <button  className= {styles.button}>agregar al carrito</button>
         ...
         <div className = {styles.colum3}>
            ...
            <div className = {styles.row2}>
                ...
                Procesador: Intel o AMD de doble núcleo de 64 bits a 2.8 GHz
                Memoria: 4 GB de RAM
