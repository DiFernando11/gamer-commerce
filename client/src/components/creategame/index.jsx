        ...
        <div className="font-cgame">
            <div className="container">
                <form className="form-cgame" onSubmit={(e)=>handleSubmit(e)}>
                    ...
                    <p>Description:</p>
                    <input className="inputs" type="textarea" name="description" onChange={(e)=> handleChange(e)} value={input.description}/>
                        {error.description && <p className="error">{error.description}</p>}
                    <p>Released:</p>
                    <input className="inputs" type="number" name="released" onChange={(e)=> handleChange(e)} value={input.released}/>
                        {error.released && <p className="error">{error.released}</p>}
                    <p>Price: </p>
                    <input className="inputs" type="number" name="price" onChange={(e)=> handleChange(e)} value={input.price}/>
                        {error.price && <p className="error">{error.price}</p>}
                    <p>Ranting: </p>
                    <input className="inputs" type="number" name="rating" onChange={(e)=> handleChange(e)} value={input.rating}/>
                        {error.rating && <p className="error">{error.rating}</p>}
                    <p>Website: </p>
                    <input className="inputs" type="text" name="website" onChange={(e)=> handleChange(e)} value={input.website}/>
                        {error.website && <p className="error">{error.website}</p>}
                    <p>Developers: </p>
                    <input className="inputs" type="text" name="developers" onChange={(e)=> handleChange(e)} value={input.developers}/>
                        {error.developers && <p className="error">{error.developers}</p>}
                    <p>System Requirements Min: </p>
                    <input className="inputs" type="textarea" name="requirements_min" onChange={(e)=> handleChange(e)} value={input.requirements_min}/> 
                        {error.requirements_min && <p className="error">{error.requirements_min}</p>}
                    <p>System Requirements Max: </p>
                    <input className="inputs" type="textarea" name="requirements_max" onChange={(e)=> handleChange(e)} value={input.requirements_max}/>
                        {error.requirements_max && <p className="error">{error.requirements_max}</p>}
                    <p>Image:</p>
                    <input multiple className="inputs" type="file" name="image" onChange={(e)=> handleChange(e)} value={input.image}/>
                    <p>
